...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-10 px-6 mt-15 ">
      <div className="max-w-[1240px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 border-b border-gray-800 pb-10">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-400 pr-8">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="" className="flex items-center text-gray-400 hover:text-white text-sm">
                  <span className="mr-2 text-xl w-[25px] "><Linkedin /></span>@CS — Ticket System
                </a>
              </li>
              <li>
                <a href="" className="flex items-center text-gray-400 hover:text-white text-sm">
                  <span className="mr-2 text-xl w-[25px]"><Facebook /></span>@CS — Ticket System
                </a>
              </li>
              <li>
                <a href="" className="flex items-center text-gray-400 hover:text-white text-sm">
                  <span className="mr-2 text-xl w-[25px]"><Mail /></span>support@cst.com
                </a>
              </li>
            </ul>
          </div>
